...
public class QcmController extends Controller {
    ...
    public static Result index() {
        return ok(qcm.render(buildQcm(), qForm, score, null, QcmDao.listAll()));
    }
    ...
    public static Result validateResponses() {
        ...
        return ok(qcm.render(buildQcm(), filledForm, score, "EVAL", null ));
    }
    ...
    public static Result score() {
        ...
        return ok(qcm.render(buildQcm(), qForm, score, "EVAL", QcmDao.listAll() ));
    }
