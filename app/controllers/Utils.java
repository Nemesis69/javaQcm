...
public class Utils extends Controller{
    ...
    static Questionnaire convertDbQuestToXmlQuest(Qcm qcm) throws DatatypeConfigurationException {
    ...
    static List<Question> convertXmlQuestionsToDbQuest(List<Questionnaire.Question> questions, Qcm qcm) {
